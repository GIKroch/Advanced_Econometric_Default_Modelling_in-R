...
hl
```
P-value of the test is 0.2428 which is above our significance level. This means that we can not rejest null hypothesis that the model is correctly specified.
